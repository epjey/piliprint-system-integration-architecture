...
bookbind: `<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M34 38 l3 3 l5-5" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round"
...
lamination: `<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="30" y="34" text-anchor="middle" font-size="8" font-weight="bold" fill="#3d6294"
        font-family="Arial">LAMINATE</text>
</svg>`,
